...
export default function MisOrdenes({ profile }) {
  ...
  function printTicket(o, orderItems) {
    ...
    const html = '<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8">' +
      ...
      '*{box-sizing:border-box;margin:0;padding:0;-webkit-text-stroke:0.5px #000}' +
      ...
      notesBlock +
      deliveryNotesBlock +
      '<div class="foot">Estado: ' + (o.status||'').toUpperCase() + ' — Gracias por su preferencia</div>' +
      '</body></html>'
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'flex-end', marginTop: '1rem' }}>
                    ...
                    <button type="button" className="btn btn--primary"
                      onClick={() => printTicket(savedOrder, savedOrder.order_items || [])}>
                      🖨 Imprimir Ticket
                    </button>
                  </div>
                </div>
